...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mAbdul Nasir
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+923329031938
\x1b[93;1m Facebook       \x1b[92;1m=>      \x1b[93;1mAbdul Nasir
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [NASIR] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [NASIR-CP] %s|%s        '%(b,idf,pw))
